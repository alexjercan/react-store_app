...
const getLocation = (
  success: (coordinates: ICoordinates) => void,
...
const requestLocationPermission = (
  callback: (result: PermissionStatus) => void,
) => {
    ...
    requestLocationPermission((status) => {
      if (status === PermissionsAndroid.RESULTS.GRANTED) {
        getLocation((coordinates) => {
          ...
          fetchStores(coordinates, maxRadius, (stores) =>
            setAllStores(stores.map(toStore)),
          );
        });
      }
    });
